...
export default function AboutPage() {
  const techStack = [
    ...
    {
      name: "Google Gemini 3.6 & Safety Guardrails",
      category: "AI & Live Context",
      description:
        "Context-grounded assistant with dynamic live order tracking, one-click cancellation, and strict domain guardrails preventing arbitrary code generation.",
      icon: "🤖",
      badge: "GenAI & Safety",
      gradient: "from-indigo-600/10 to-purple-600/10 border-indigo-200/60",
  ...
  return (
    <main className="min-h-screen pb-20">
      ...
      {/* Developer Profile & Open Source Section */}
      <section className="max-w-4xl mx-auto px-4 pt-16 sm:pt-20">
        <div className="bg-white border border-neutral-200 rounded-3xl p-8 sm:p-10 shadow-sm space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-6 border-b border-neutral-100">
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white font-extrabold text-2xl flex items-center justify-center shadow-md">
                VR
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-xl font-bold text-neutral-900">Varshith Raj Basa</h2>
                  <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200">
                    Lead Developer
                  </span>
                </div>
                <p className="text-xs text-neutral-500 mt-0.5">
                  Full-Stack Web & AI Application Engineer
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-neutral-900 text-white hover:bg-black transition shadow-xs"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-[#0A66C2] text-white hover:bg-[#004182] transition shadow-xs"
              >
                <span>LinkedIn</span>
                <span>↗</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold border border-neutral-300 hover:bg-neutral-50 text-neutral-800 transition"
              >
          ...
          <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
            I engineer resilient, type-safe full-stack web applications and intelligent AI agent workflows. NextStore is an architectural showcase combining modern Next.js 16, React 19, MongoDB connection pooling, and domain-grounded GenAI support with strict business safety guardrails.
          </p>
        </div>
      </section>
